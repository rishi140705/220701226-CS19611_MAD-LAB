...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btSetAlarm.setOnClickListener {
            Toast.makeText(applicationContext, "Alarm ON...!",
            ...
            pendingIntent = PendingIntent.getBroadcast(this.applicationContext,
                2, intent, PendingIntent.FLAG_CANCEL_CURRENT or PendingIntent.FLAG_MUTABLE)
            val time:Long = calendar.timeInMillis - (calendar.timeInMillis %
                    60000)
        ...
        btStopAlarm.setOnClickListener {
            ...
            Toast.makeText(applicationContext, "Alarm OFF...!",
                Toast.LENGTH_LONG).show()
        }
    }
}